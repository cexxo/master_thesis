...
int main(){
    ...
    std::vector<std::string> actions = {"left","right","align"};
    std::cout << exo.set_qLearner(0.1,0.7,0.9,2,actions,3) << std::endl;                  //In the simplest case i have 3 states: before, on top and after the obstacle.
